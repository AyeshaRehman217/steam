...
Route::group(['middleware' => ['auth', 'verified', 'xss', 'user.status', 'user.module:manager'], 'prefix' => 'manager', 'as' => 'manager.'], function () {
    ...
    // User Registration
    Route::resource('conference-year/{yid}/user-registration', UserRegistrationController::class, ['as' => 'conference-year']);
...
//    Route::get('get-user-registration-select', UserRegistrationController::class, 'getIndexSelect'])->name('get.user-registration-select');
    Route::get('conference-year/{yid}/get-user-registration-status/{id}', [UserRegistrationController::class, 'editStatus'])->name('get.user-registration-status');
    Route::put('conference-year/{yid}/get-user-registration-update-status/{id}', [UserRegistrationController::class, 'updateStatus'])->name('get.user-registration-update-status');
    Route::get('conference-year/{yid}/get-user-registration-certificate-status/{id}', [UserRegistrationController::class, 'editCertificateStatus'])->name('get.user-registration-certificate-status');
    Route::put('conference-year/{yid}/get-user-registration-update-certificate-status/{id}', [UserRegistrationController::class, 'updateCertificateStatus'])->name('get.user-registration-update-certificate-status');
    Route::get('conference-year/{yid}/get-user-registration-activity/{id}', [UserRegistrationController::class, 'getActivity'])->name('get.user-registration-activity');
    ...
    Route::get('conference-year/{yid}/get-user-registration-activity-trash', [UserRegistrationController::class, 'getTrashActivity'])->name('get.user-registration-activity-trash');
    ...
    Route::put('conference-year/{yid}/upload-voucher/{id}', [UserRegistrationController::class, 'upload'])->name('upload-voucher');
    ...
    // Abstract Submission
    Route::resource('conference-year/{yid}/user-registration/{uid}/paper-submission', PaperSubmissionController::class, ['as' => 'conference-year.user-registration']);
