        ...
        <tr>
            <td style="width: 34%; border-right: 1px dotted #000;">
                <table style="width: 100%;">
                    <div style="width: 100%; margin-top: 3%; margin-left: 50%;">
                        <img src="{{asset('front/coreui/images/tuf_logo.png')}}" style="width: 50%; margin: 0 auto;" />
                    </div>
                    <tr>
                        <td colspan="2">
            ...
            <td style="width: 34%; border-right: 1px dotted #000;">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td><label class="small">Date:</label><input type="text" class="border-bottom"
                                                                     value="{{$voucher->last_date}}"
                                                                     style="width: 100px;margin-top: 10px;">
                        </td>
                        <td><label class="small">Challan#:</label><input type="text" class="border-bottom"
