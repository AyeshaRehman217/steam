                        ...
                        render: function (data, type, row, meta) {
                            ...
                            return '<div class="d-flex">' +
                                ...
                                @endcan
                                    ...
                                    '<a class="mx-2" href="' + USER_REGISTRATION + '" data-coreui-toggle="tooltip" data-coreui-placement="top" title="User Registration"> <span class="badge bg-primary text-light">More<i class="fa fa-forward ms-2"></i></span> </a>' +
                                @endcan
                                    '</div>'
