    ...
    <div class="info-sec">
        <div class="container">
           <div class="info-countdown" style="background-image: url(front/coreui/assets/img/banner/bg.png);">
              <ul class="counter-box d-flex justify-content-around" data-countdown="2023/12/7">
              </ul>
     ...
     <section id="about" class="about-sec">
        <div class="container">
           <div class="section-head col-xl-9 m-auto text-center mb-5">
              ...
              <p class="desc mx-3">
               The 1<sup>st</sup> International Conference on Advanced STEAM Education: Challenges and Opportunities, 2023 is  orchestrated by The University of Faisalabad (TUF). This eminent conference is primed to congregate forward-thinking pedagogues, pioneering scholars, dynamic implementors and fervent devotees hailing from diverse corners of the planet to engage in profound discourse concerning the pivotal matter of progressing STEAM pedagogy and to probe the multifaceted complexities and prospects it offers.
              </p>
           </div>
              ...
              <div class="row justify-content-center g-4">
               ...
               <div class="col-12" data-aos="fade-right" data-aos-duration="800">
                  <div class="about-item">
                   <div class="item-thumb">
                     <div class="advisory-img">
                      <img src="front/coreui/assets/img/advisory/patron-new.png" alt="About Images"></div>
                 ...
                 <div class="col-12" data-aos="fade-right" data-aos-duration="800">
                  <div class="about-item">
                   <div class="item-thumb">
                     <div class="advisory-img">
                      <img src="front/coreui/assets/img/advisory/chairperson-new.png" alt="About Images"></div>
                      <div class="item-content">
                         <div class="content-title text-white">
                            <span class="date">
                              Ms. Zahida Maqbool
               ...
               <div class="col-12" data-aos="fade-right" data-aos-duration="800">
                  <div class="about-item"> 
                   <div class="item-thumb">
                      <div class="advisory-img">
                      <img src="front/coreui/assets/img/advisory/dr_majid_hussain.jpeg" alt="About Images">
                      </div>
                      <div class="item-content">
                         <div class="content-title text-white">
           ...
           <div class="schedule-content-wrap">
              <ul class="nav nav-pills schedule-nav-tab mb-5" id="pills-tab" role="tablist">
                 <li class="nav-item schedule-nav-item" role="presentation">
                    <button class="nav-link active" id="pills-day-1-tab" data-bs-toggle="pill" data-bs-target="#pills-day-1" type="button" role="tab" aria-controls="pills-day-1" aria-selected="true">Day 01</button>
                 </li>
                 <li class="nav-item schedule-nav-item" role="presentation">
                    <button class="nav-link" id="pills-day-2-tab" data-bs-toggle="pill" data-bs-target="#pills-day-2" type="button" role="tab" aria-controls="pills-day-2" aria-selected="false">Day 02</button>
                 </li>
                 {{-- <li class="nav-item schedule-nav-item" role="presentation">
        ...
        <div class="container">
           <div class="cta-content-wrap text-center" data-aos="fade-right" data-aos-duration="1000">
              <h2 class="cta-title  m-auto mb-4 mx-5">
               Join Us with Empowering Minds, Igniting Future, Exploring Challenges and Opportunities in Advanced STEAM Education with in Real World Scenarios
              </h2>
              {{-- <p class="desc mb-5">
              ...
              <div class="dots">
                 <img src="front/coreui/assets/img/dots/dots9.png" alt="Shadow Image" class="cta-dots-1 img-moving-anim1">
                 <img src="front/coreui/assets/img/dots/dots10.png" alt="Shadow Image" class="cta-dots-2 img-moving-anim2">
              </div>
           </div>
        </div>
        <div class="shape">
